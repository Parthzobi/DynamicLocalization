...
public final class LocalizableWrite {
    ...
    lazy var bundlePath: URL = {
        ...
        let bundlePath = documents.appendingPathComponent(LocalizableWrite.MyBundleName, isDirectory: true)
        return bundlePath
    }()
